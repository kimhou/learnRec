...
/******/ 	__webpack_require__.p = "/buildTools/webpack/out/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ejsContent = __webpack_require__(2);
	...
	module.exports = new ((function () {
	    ...
	    _createClass(_class, [{
	        key: 'init',
	        value: function init() {
	            ReactDOM.render(React.createElement(Page, null), document.getElementById('content1'));

	            $('body').append(ejsContent({ msg: 'ejs module' })).append($('<div><button>async load</button></div>').click(function () {

	                __webpack_require__.e/* nsure */(1, function () {
	                    var mod1 = __webpack_require__(7);
